...
```text
5504cfea9daf4ff5a582ff7d95b50a48310d4eaa
```
...
successful PyPI publication, verify `pip install project-guard==0.5.0` in a
clean environment before changing the README's primary installation command.
